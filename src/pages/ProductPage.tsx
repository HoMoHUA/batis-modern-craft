...
const products = [
  {
    ...
    longDescription: `میز مدیریت اجرایی باتیس مدرن یک شاهکار در طراحی صنعتی است. این محصول با ترکیب منحصربه‌فرد چوب نراد خشک‌شده در کوره‌های صنعتی و پروفیل فولادی با ضخامت ۲ میلی‌متر ساخته شده است.
...
این میز مناسب برای دفاتر مدیریتی، اتاق‌های کنفرانس و فضاهای کاری مدرن است. طراحی ارگونومیک آن، کار طولانی‌مدت را راحت و بدون خستگی می‌کند.`,
  ...
  },
  {
    ...
    longDescription: `صندلی مدیریت ارگونومیک باتیس مدرن با طراحی منحصربه‌فرد و استفاده از بهترین مواد اولیه ساخته شده است.
...
این صندلی با ترکیب چوب نراد خشک‌شده و اسکلت فولادی، هم زیبایی و هم استحکام را در خود جای داده است. پشتی قابل تنظیم و نشیمنگاه ارگونومیک، ساعت‌ها کار پشت میز را راحت می‌کند.`,
  ...
  },
  {
    ...
    longDescription: `کتابخانه صنعتی مدرن باتیس با ۵ طبقه قابل تنظیم، فضای ذخیره‌سازی ایده‌آل برای کتاب‌ها، دکوری‌ها و لوازم شخصی فراهم می‌کند.
